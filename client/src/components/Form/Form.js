            ...
            <div>
                <Form>
                    ...
                    <FormGroup>
                        ...
                        <Input onChange={this.handleInputChange} value={this.state.notes} type="textarea" name="notes" id="notes" />
                    </FormGroup>


                    <Button onClick={this.handleFormSubmit} color="info">Submit</Button>
